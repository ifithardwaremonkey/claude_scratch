...
| Revision | 1.18 draft, 17 September 2026. Full history in Section 10 |
...
|---|---|---|
| ME1 | Malata receives `efuse_iFitG520.img` (hash-verified by ICON against G4) and the signed `DA_BR.bin` by the H4 controlled channel, not project chat or email | The custody route is itself a Tier 2 requirement; exercising it early finds the gaps |

...
| Revision | 1.4 draft, 12 September 2026 (1.0 to 1.3 issued earlier the same day) |
...
| G2 | STOP-SHIP Certificate chain | `otacert`, `platform.x509.pem` and the AVB image key all resolve to the ICON certificate; none matches an AOSP test key. **Closed on 0909** (SHA-256 `61:7C:CC:...:1B:BF`, O = Icon Health and Fitness). Repeat on 0919 | ICON |
